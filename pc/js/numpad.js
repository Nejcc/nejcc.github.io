import topDisplays from "./topDisplays.js";
...
var display = new Vue({
    ...
    methods: {
        ...
        pressButton(number) {
            ...
            if (topDisplays.lcdVerb) {
                // topDisplays.lcdVerb = topDisplays.lcdVerb + number;
                topDisplays.lcdVerb = topDisplays.lcdVerb + number;
            }
            if (this.noun) {
        ...
        btnEntr: function () {
            ...
            this.blinkLed(100, 3000, 'reset', 'progClasses').then(() => {
                this.illuminateLed(1000, 'reset', 'progClasses').then(() => {
                    ...
                    //only this part   is LOGIC
                    //its better to refector according to modules. i mean ...what can i say..
                    // XD  i will try  for example how to call this  in here if i have in separate file?
                    //blinkLed.?? this login part needs to be in a function.then you can call like
                    // blinkLed.logic()
                    // and logic function have to be defined in separtae file. yes
                    if (this.lcdProg == '19') {
                        console.log('19');
                        //load
                        if (topDisplays.lcdVerb == '15') {
                            console.log('18');
                            //bank A
                            if (this.lcdNoun == '01') {
                                console.log('01');
                        ...
                        //store
                        else if (topDisplays.lcdVerb == '24') {
                            console.log('24');
                            //bank a
                            if (this.lcdNoun == '01') {
                                console.log(' noun 01');
                            ...
                            this.lcdRel = '0000';
                        } else if (topDisplays.lcdVerb == '35') {
            ...
            //if you only want to move these functions the you can make js files and use classes
        ...
        btnVerb: function () {
            ...
            this.lcd = this.lcd + topDisplays.lcdVerb;
